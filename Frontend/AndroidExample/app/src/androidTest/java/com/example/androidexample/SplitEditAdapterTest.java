...
public class SplitEditAdapterTest {
    ...
    @Test
    public void testViewHolder_ItemViewNotNull() {
        adapter = new SplitEditAdapter(splits, CURRENT_USER, true);
        ViewGroup parent = createMockParent();
        SplitEditAdapter.ViewHolder holder = adapter.onCreateViewHolder(parent, 0);
    ...
    @Test
    public void testViewHolder_TextViewNotNull() {
        adapter = new SplitEditAdapter(splits, CURRENT_USER, true);
        ViewGroup parent = createMockParent();
        SplitEditAdapter.ViewHolder holder = adapter.onCreateViewHolder(parent, 0);
    ...
    @Test
    public void testViewHolder_ShareEditTextNotNull() {
        adapter = new SplitEditAdapter(splits, CURRENT_USER, true);
        ViewGroup parent = createMockParent();
        SplitEditAdapter.ViewHolder holder = adapter.onCreateViewHolder(parent, 0);

        assertNotNull(holder.etShare);
        assertTrue(holder.etShare instanceof EditText);
    }

    @Test
    public void testViewHolder_PaidEditTextNotNull() {
        adapter = new SplitEditAdapter(splits, CURRENT_USER, true);
        ViewGroup parent = createMockParent();
        SplitEditAdapter.ViewHolder holder = adapter.onCreateViewHolder(parent, 0);

        assertNotNull(holder.etPaid);
        assertTrue(holder.etPaid instanceof EditText);
    }
    ...
    public void testViewHolder_AllFieldsInitializedCorrectly() {
        ...
        assertEquals(holder.etShare, holder.itemView.findViewById(R.id.etShareAmount));
        assertEquals(holder.etPaid, holder.itemView.findViewById(R.id.etPaidAmount));
    }
    ...
    public void testViewHolder_MultipleInstances() {
        ...
        SplitEditAdapter.ViewHolder holder1 = adapter.onCreateViewHolder(parent, 0);
        SplitEditAdapter.ViewHolder holder2 = adapter.onCreateViewHolder(parent, 0);
        SplitEditAdapter.ViewHolder holder3 = adapter.onCreateViewHolder(parent, 0);
